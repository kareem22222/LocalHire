...
of the TermsFeed Privacy Policy Generator.
</p>
...
<ul>
  ...
  <li>
    <strong>To provide You with news, special offers, and general information
    about other goods, services and events</strong> which We offer that are
...
<ul>
  <li>
    <strong>Website analytics data (cookies, IP addresses, device
    identifiers):</strong> up to 24 months from the date of collection, which
    allows us to analyze trends while respecting privacy principles.
  </li>

  <li>
    <strong>Server logs (IP addresses, access times):</strong> up to 24 months
