...
.worker-primary { color: #fff; background: linear-gradient(135deg, #188853, #21a947); }
.worker-outline { color: #188853; border: 1.5px solid rgba(33, 169, 71, 0.3); background: #fff; }
...
.worker-eyebrow { display: inline-flex; margin-bottom: 10px; padding: 6px 10px; color: #188853; border-radius: 999px; background: rgba(33, 169, 71, 0.1); font-size: 11px; font-weight: 800; text-transform: uppercase; }
.worker-detail-hero h1 { color: #0b3658; font-family: Manrope, sans-serif; font-size: clamp(30px, 5vw, 44px); }
.worker-detail-hero p, .worker-detail-description, .worker-page-empty p { margin-top: 8px; color: #5d7482; line-height: 1.7; }
...
.worker-detail-grid dt, .worker-detail-group h3 { color: #6f8794; font-size: 11px; font-weight: 800; letter-spacing: .07em; text-transform: uppercase; }
...
.worker-detail-chips span { padding: 7px 11px; color: #376150; border-radius: 999px; background: rgba(33, 169, 71, 0.09); font-size: 12px; font-weight: 700; }
.worker-application-notice { padding: 16px 20px; color: #376150; border: 1px solid rgba(33, 169, 71, 0.25); border-radius: 14px; background: #fff; }
